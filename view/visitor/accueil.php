...
<?php ob_start(); ?>
  ...
  <div class="container">
    ...
    <div id="col-centre">
      ...
      <?php foreach($lastPubli as $afficherPubli) {
          ?>
        <div class="publi-social">
          <div class="entete-publi">
            <h2 class="titre-publi"><?= htmlspecialchars($afficherPubli['titreArticle']) ?></h2>
            <p class="info-publi">Publié le <?= $afficherPubli['dateCreation'] ?><br>Par <?= htmlspecialchars($afficherPubli['prenomAuteur'])." ".htmlspecialchars($afficherPubli['nomAuteur']) ?>
            </p>
          </div>
          <p class="contenu-publi"><?= htmlspecialchars($afficherPubli['articleContent']) ?></p>
          <hr>
        </div>
      <?php
      }
